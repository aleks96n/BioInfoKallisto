...
If you did get the permission error during execution of the nextflow command below, and you fixed it with the above chmod command, you can resume where you left off by running the same command again with the -resume flag.
